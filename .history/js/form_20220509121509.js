...
function montaTr(paciente){
    ...
    var pesoTd = montaTd(paciente.peso,classe);
    var alturaTd = montaTd(paciente.altura,classe);
    var gorduraTd = montaTd(paciente.gordura,classe);
    var imcTd = montaTd(paciente.imc,classe);
